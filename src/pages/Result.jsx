...
const Result = () => {
            ...
            try {
                ...
                if (navigator.share && blob) {
                    ...
                    await navigator.share({
                        files: [file],
                        title: "Nəticəniz",
                        text: "İş dəyərləri alətindəki nəticəm",
                    });
                } else {
    ...
    return (
        <div ref={captureRef} className="bg-[#F8F8F8] py-36">
            <div>
                <img
                    className="absolute top-[300px]"
                    src="assets/img/_b14be35a-6806-4ff9-b756-40f9df3013fa 2.png"
                    alt=""
                />
                <img
                    className="absolute top-[887px]"
                    src="assets/img/baloon2 1.png"
                    alt=""
                />
                <img
                    className="absolute right-0 top-[452px]"
                    src="assets/img/baloon.png"
                    alt=""
                />
                <img
                    className="absolute left-6 top-[625px]"
                    src="assets/img/Layer-0-copy1 3.png"
                    alt=""
                />
                <img
                    className="absolute top-40 right-0"
                    src="assets/img/Layer-0-copy1 4.png"
                    alt=""
                />
                <img
                    className="absolute top-[750px] right-16"
                    src="assets/img/star2.png"
                    alt=""
                />
                <img
                    className="absolute top-[980px] right-28"
                    src="assets/img/Layer-0-copy1 2.png"
                    alt=""
                />
            </div>
            ...
            <div className="wrapper">
                <header>
                    <p className="font-bold text-[#CED8E3] text-2xl">
                        İş dəyərləri aləti
                    </p>
                    <h1 className="text-[#003C67] font-bold text-5xl mt-5">
                        Nəticəniz
                    </h1>
                </header>
                ...
                <div className="flex items-start gap-8 mt-10">
                    <div className="p-10 bg-white rounded-2xl w-[680px]">
                        <div className="flex gap-6 items-center">
                            <span className="bg-[#1DDD76] text-white text-3xl px-7 py-2 rounded-full font-bold">
                                {data[0].category}
                            </span>
                            <span className="text-[#6F8193] text-xl">
                                1-ci dəyəriniz
                            </span>
                        </div>
                        <p className="mt-10 text-[#6F8193] text-2xl">
                            {data[0].description}
                        </p>
                        <div className="mt-11">
                            <p className="text-[#6F8193] text-xl">
                                Dəyərə görə uyğun peşə siyahısı
                            </p>
                            <ul className="mt-3 flex flex-wrap gap-2">
                                {(activeFirst ? jobFirst.slice(0, 5) : jobFirst).map(
                                    (item, index) => (
                                        <li
                                            key={index}
                                            className="text-[#1DDD76] border border-[#1DDD76] rounded-full font-medium text-xl py-2 px-10"
                                        >
                                            {item}
                                        </li>
                                    )
                        ...
                        {jobFirst.length > 5 && (
                            <button
                                ...
                                className="bg-[#2BE597] text-white rounded-lg h-[50px] w-64 mt-11"
                            >
                                Daha {activeFirst ? "çox" : "az"} peşə gör
                            </button>
                        )}
                    </div>
                    ...
                    <div className="p-10 bg-white rounded-2xl w-[680px]">
                        <div className="flex gap-6 items-center">
                            <span className="bg-[#776BFD] text-white text-3xl px-7 py-2 rounded-full font-bold">
                                {data[1].category}
                            </span>
                            <span className="text-[#6F8193] text-xl">
                                2-ci dəyəriniz
                        ...
                        <div className="mt-11">
                            ...
                            <ul className="mt-3 flex flex-wrap gap-2">
                                {(activeSecond ? jobSecond.slice(0, 5) : jobSecond).map(
                                    (item, index) => (
                                        <li
                                            key={index}
                                            className="text-[#7C81FF] border border-[#7C81FF] rounded-full font-medium text-xl py-2 px-10"
                                        >
                                            {item}
                                        </li>
                                    )
                        ...
                        {jobSecond.length > 5 && (
                            <button
                                ...
                                className="bg-[#7C81FF] text-white rounded-lg h-[50px] w-64 mt-11"
                            >
                                Daha {activeSecond ? "çox" : "az"} peşə gör
                            </button>
                        )}
                    </div>
                </div>
            ...
            <div className="my-10 flex gap-4 justify-center">
                ...
                <Button send={'/evaluate'} bgcolor="#4132EA" color="#fff">
                    <img src="assets/img/tool.svg" alt="Icon" />
                    <p>Aləti qiymətləndir</p>
                </Button>
                <button
                    className="bg-[#32A9FF] text-white rounded-lg px-8 py-4 flex items-center gap-2"
